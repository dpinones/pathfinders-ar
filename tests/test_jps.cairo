%lang starknet
from src.jps import identify_successors, get_all_neighbours_of, get_all_neighbours_of_internal
...
//     assert points[1] = Point(1, 0, 0);
//     assert points[2] = Point(2, 0, 0);
//     assert points[3] = Point(3, 0, 0);
//     assert points[4] = Point(4, 0, 0);
//     assert points[5] = Point(0, 1, 0);
//     assert points[6] = Point(1, 1, 0);
//     assert points[7] = Point(2, 1, 0);
//     assert points[8] = Point(3, 1, 0);
//     assert points[9] = Point(4, 1, 0);
//     assert points[10] = Point(0, 2, 0);
//     assert points[11] = Point(1, 2, 0);
//     assert points[12] = Point(2, 2, 0);
//     assert points[13] = Point(3, 2, 0);
//     assert points[14] = Point(4, 2, 0);
//     assert points[15] = Point(0, 3, 0);
//     assert points[16] = Point(1, 3, 0);
//     assert points[17] = Point(2, 3, 0);
//     assert points[18] = Point(3, 3, 0);
//     assert points[19] = Point(4, 3, 0);
//     assert points[20] = Point(0, 4, 0);
//     assert points[21] = Point(1, 4, 0);
//     assert points[22] = Point(2, 4, 0);
//     assert points[23] = Point(3, 4, 0);
//     assert points[24] = Point(4, 4, 0);
...
//     assert points_expected[2] = Point(2, 0, 0);
//     assert points_expected[3] = Point(0, 1, 0);
//     assert points_expected[4] = Point(2, 1, 0);
//     assert points_expected[5] = Point(0, 2, 0);
//     assert points_expected[6] = Point(1, 2, 0);
//     assert points_expected[7] = Point(2, 2, 0);
...
func test_get_all_neighbours_of_internal{syscall_ptr: felt*, range_check_ptr, pedersen_ptr: HashBuiltin*}() {
    ...
    // llamo a la funcion
    let (result_after_len, result_after) = get_all_neighbours_of_internal(map, Point(1, 1, 0));
